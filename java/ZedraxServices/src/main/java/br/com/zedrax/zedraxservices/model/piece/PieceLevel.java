...
public class PieceLevel implements Serializable
{
	...
	@OneToMany( mappedBy = "pieceLevel", targetEntity = PieceSkillLevel.class)
	private List< PieceSkillLevel > pieceSkillLevels;
	...
	public List< PieceSkillLevel > getPieceSkillLevels()
	{
		return pieceSkillLevels;
	}
	
	public void setPieceSkillLevels( List< PieceSkillLevel > pieceSkillLevels )
	{
		this.pieceSkillLevels = pieceSkillLevels;
	}
