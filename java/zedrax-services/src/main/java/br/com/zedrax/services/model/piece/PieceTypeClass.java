 ...
 */
@Entity
@Table(name = "\"piece_type_class\"", uniqueConstraints = @UniqueConstraint(columnNames = "\"type_class\""))
public class PieceTypeClass implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "\"id_piece_type_class\"", nullable = false, insertable = false, updatable = false)
